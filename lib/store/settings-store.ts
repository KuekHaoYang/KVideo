  ...
  getSettings(): AppSettings {
    ...
    try {
      ...
      return {
        ...
        sortBy: parsed.sortBy || 'latency-asc',
        ...
        fullscreenType: (parsed.fullscreenType === 'window' || parsed.fullscreenType === 'native' || parsed.fullscreenType === 'auto') ? parsed.fullscreenType : 'native',
